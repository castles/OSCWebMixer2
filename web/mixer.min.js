'use strict';const channelsDiv=document.getElementById("channels"),auxSelect=document.getElementById("aux"),panCheckbox=document.getElementById("panning"),auxiliaries=document.getElementById("auxiliaries");let ws=null,timeout=null,channelInputs=null,panInputs=null;function sliderToDb(a){a=Math.log(100*a)/Math.log(100)*100-90;return-Infinity===a?-150:a}function dbToSlider(a){return Math.pow(100,(a+90)/100)/100}
...
function resetSlider(a){this.classList.contains("volumeInput")&&(a.target.value=0);this.classList.contains("panInput")&&(a.target.value=.5);a.target.dispatchEvent(new Event("input"))}
