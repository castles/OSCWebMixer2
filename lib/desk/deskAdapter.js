...
const { createSAdapter, validateSAuxRouting } = require("./sAdapter.js");
...
module.exports = { createDeskAdapter, createSdAdapter, createSAdapter, eventToCommand, validateSAuxRouting };
